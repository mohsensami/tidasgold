      ...
      <div className="border-b border-border bg-background/95 backdrop-blur">
        <div className="container flex h-16 items-center justify-between gap-4">
          ...
          <Link href="/" className="flex items-center gap-2 shrink-0">
            <span className="font-display text-2xl font-extrabold gold-shimmer">
              {SITE.name}
            </span>
          </Link>
          ...
          <div className="flex items-center gap-1">
            ...
            <Button variant="ghost" size="icon" asChild className="relative" aria-label="سبد خرید">
              <Link href="/cart">
                ...
                {totalItems > 0 && (
                  <span className="absolute -top-1 -left-1 flex h-5 w-5 items-center justify-center rounded-full bg-wine text-[11px] font-bold text-white">
                    {totalItems}
                  </span>
                )}
              </Link>
