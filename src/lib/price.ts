import { GOLD_PRICE, PRICE_FORMULA_DEFAULTS } from "@/lib/constants";
 ...
 */
export function calculateGoldPrice(product: Pick<Product, "weightGrams" | "wage" | "profitPercent" | "taxPercent">) {
  const pricePerGram = GOLD_PRICE.pricePerGram18k;
